...
def MoveCharacter():
    Shared.positionCharacterX -= Shared.moveCharacterX #Make the character move left and right.
    Shared.positionCharacterY -= Shared.moveCharacterY #Make the character jump.
